  ...
  return (
      ...
      <div className="modal_pop">
        <form>
          ...
          <div className="modalBody">
            <textarea rows="5" placeholder="What's on your mind Akhilesh ?" onChange=
            {e=>setMessage(e.target.value)}>{message}</textarea>
          </div>
          ...
          {image!=="" && <h2 style={{"fontSize":"20px",
    "marginLeft":"90px",
    "marginBottom":"20px",
    "color":"green"}}>Image is added! Click on Post!</h2>}
    ...
    <div className="messagesender">
        ...
        <Avatar src={user.photoURL}/>
            ...
            <form>
                <input type="text" placeholder="What's on your mind Akhilesh?" onClick={handleOpen}/>
            </form>
        </div>
